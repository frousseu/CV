...
%\fax{+}
\email{francoisrousseu@hotmail.com}
%\homepage{w}
%\extrainfo{}
...
{Aide des étudiants gradués et des professeurs avec tout ce qui entoure l'analyse quantitative de données écologiques, les statistiques et la programmation, notamment avec R.}
...
\cventry{Hiver 2011\\Autumne 2013}{Biologiste}{Environnement Canada/SCF/Regroupement QuébecOiseaux}{}{}
...
\cventry{Automne 2010\\à hiver 2012}{Chargé de cours}{Université de Sherbrooke}{}{}
%\cventry{Fall 2010\\to Winter 2012}{Teacher}{University of Sherbrooke}{}{}
{Titre du cours : Acquisition et traitement de données écologiques. Il s'agit d'un cours de 30 heures donné dans le cadre du programme de maîtrise en écologie internationale. Le cours traite des principales méthodes statistiques utilisées en écologie et de l'utilisation du logiciel R.}
